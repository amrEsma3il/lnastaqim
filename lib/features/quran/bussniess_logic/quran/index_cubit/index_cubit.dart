...
class IndexCubit extends Cubit<int> {
    ...
    switch (remainder) {
      ...
      default:
        return quarterNumber
            .toString(); // Just in case, though this should never be reached
    }
  }
  ...
  moveToPageEvent(
    ...
    int page, {
    bool isFromDialog = true,
  }) async {
    dev.log("Moving to page: $page.  after conversion: ${604 - page}");
    {
  ...
  static List<SurahModel> getQuranSurah() => QuranRepository.getQuranSurah();

  static List<JuzModel> getQuranJuz() => QuranRepository.getQuranJuz();
}
