...
final bool isFromDialog;
  const QuranHizpComponent({super.key, required this.hizp, this.isFromDialog = true});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () async {
        dev.log(
          "Tapped on Surah: ${hizp.page} with start page: ${hizp.page}",
        );
  ...
  if (isFromDialog) {
           ...
           if (context.mounted) {
            BlocProvider.of<IndexCubit>(
              context,
            ).moveToPageEvent(context, 604 - hizp.page);
          }
          ...
          AudioControlCubit.get(context).updatePage(hizp.page,context);
        await FontDownloadPercentage().downloadAndLoadSurroundingFonts(
          currentPage:hizp.page,
              ...
              children: [
                Stack(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        IndexCubit.hizbQuarterToFraction(
                          hizp.hizbQuarter,
                        ).toArabic,
                ...
                Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 4.h),
                    Text(
                      "الصفحة ${hizp.page.toString().toArabic} - ${QuranCubit.removeTashkeel(hizp.surahName)} ${hizp.numberInSurah.toString().toArabic}",
                      style: TextStyle(
