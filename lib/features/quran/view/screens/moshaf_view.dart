...
class MoshafView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // final bool quranDownloadCheak=await FontService.getfontServiceInstance().checkAnyChapterDownloaded();
    return Scaffold(
 ...
 QuranCubit.get(context).clearScreen(context);
        ...
        color: Colors.white,
          ...
          child: const CircularProgressIndicator(color: AppColor.blueColor,));  // تحميل
      } else if (snapshot.hasError) {
        return Container(width: Get.width,
        height: Get.height,
        color: Colors.white,
          child: const Text('حدث خطأ'));
      } else {
        bool quranDownloadCheck = snapshot.data ?? false;


        if (quranDownloadCheck) {
        return   QuranBody(cubit: QuranCubit.get(context));
        } 
                  ...
                  itemBuilder: (context, index) {
                    return Stack(
                      children: [
                        GestureDetector(
                          onTap: () {
                            SearchVisabilityCubit.get(context)
                                .searchClose();
                            ScreenOverlayCubit.get(context)
                                .overlaysVisability();
                            if (!verseSoundstate.isPlaying) {
                                                            ...
                                                            icon: BlocBuilder<
                                                              ...
                                                              builder: (context,
                                                                ...
                                                                bool isBooked = moshafBookmarkState
                                                                        .isMark &&
                                                                    moshafBookmarkState.pageNumber ==
                                                                        (604 -
                                                                            index);
                                                          ...
                                                          children: [
                                                            AnimatedOpacity(
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    cubit.getSurahNameFromPage(603 -
                                                                        index),
                                                                    style: TextStyle(
                                                                        fontSize: 24
                                                                            .sp,
                                                                ...
                                                                children: [
                                                                  Positioned(
                                                                    child:
                                                                      ...
                                                                      onPressed:
                                                                          () {
                                                                        context.read<AudioControlCubit>().toggleRepeat();
                                                                      },
                                                                    ),
                                                                  ),
                                                                  Positioned(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        (verseBarStatus.maxRepeats + 1).toString().toArabic,
                                                                        style:
                                      ...
                                      children: List.generate(ayahs.length,
                                        ...
                                        if (bookmarkedAyah != null &&
                                          ...
                                          return span(
                                            ...
                                            fontFamily: 'quran_font_${(pageIndex+1).toString().padLeft(3,'0')}',
